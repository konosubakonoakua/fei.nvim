...
local _config = require("lazy.core.config")
-- local _plugin = require("lazy.core.plugin")
_config.options.checker.enabled = false
_config.options.change_detection.enabled = false
_config.options.defaults.cond = function(plugin)
