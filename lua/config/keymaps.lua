...
local _lazyterm       = function() _util.terminal(nil, { cwd = _util.root(), ctrl_hjkl = false }) end
...
keymap_force("n", "<leader>sg", _util.telescope("live_grep"),                                        { desc = "Grep (cwd)" })
keymap_force("n", "<leader>sG", _util.telescope("live_grep", { cwd = false }),                       { desc = "Grep (root dir)" })
keymap_force("v", "<leader>sw", _util.telescope("grep_string"),                                      { desc = "Selection (cwd)" })
keymap_force("n", "<leader>sw", _util.telescope("grep_string", { word_match = "-w" }),               { desc = "Word (cwd)" })
keymap_force("v", "<leader>sW", _util.telescope("grep_string", { cwd = false }),                     { desc = "Selection (root dir)" })
keymap_force("n", "<leader>sW", _util.telescope("grep_string", { cwd = false, word_match = "-w" }),  { desc = "Word (root dir)" })
-- #endregion telescope
